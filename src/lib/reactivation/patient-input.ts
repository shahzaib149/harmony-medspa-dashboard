...
export type PatientInput = { name:string; phone:string; email:string; lastVisit:string; lastTreatment:string; status:string; smsConsent:boolean; emailConsent:boolean; consentSource:string; optedOut:boolean; doNotContact:boolean; futureBooking:boolean };
...
export const emptyPatient:PatientInput={name:"",phone:"",email:"",lastVisit:"",lastTreatment:"",status:"New",smsConsent:false,emailConsent:false,consentSource:"",optedOut:false,doNotContact:false,futureBooking:false};
...
export function csvPatient(row:Record<string,string>):Record<string,unknown> {
  const aliases:Record<string,string>={name:"name",patientname:"name",fullname:"name",phone:"phone",phonenumber:"phone",email:"email",emailaddress:"email",lastvisit:"lastVisit",lastvisitdate:"lastVisit",lasttreatment:"lastTreatment",status:"status",smsconsent:"smsConsent",emailconsent:"emailConsent",consentsource:"consentSource",optedout:"optedOut",donotcontact:"doNotContact",futurebooking:"futureBooking"};
