...
import { DEFAULT_CAMPAIGN, CLINIC_ZONE, MAX_ENROLL, activeEnrollment, exclusionReasons, nextClinicSend, clinicSendISO, type Patient, type PatientMessage, type Workspace, type EnrollmentResult } from "@/lib/reactivation/model";
