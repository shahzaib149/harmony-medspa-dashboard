...
export default function AddPatients({onAdded}:{onAdded:()=>void|Promise<void>}){
  ...
  function template(){
    const text="Name,First Name,Email,Phone,Last Visit Date,Last Treatment,Status,Source,Email Consent,Opted Out,Do Not Contact,Future Booking,Notes\r\n";
